...
?>
                <div class="container-md row align-items-center" action>
                    <form class="row g-4 d-block col" >
                        <div class="col-md-4 ">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <input type="text" class="rounded-pill form-control is-valid border border-dark" id="validationServer04"" name="nome">
                        </div>
                
                        <div class="col-md-4">
                            <input class="btn btn-outline-dark border border-dark rounded-pill" type="submit" value="Inserir">
